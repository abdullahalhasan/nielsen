...
<body>
        ...
        <div class="container">
            ...
            <h1>13001b COMMUNICATION AND PROMOTION</h1>
            ...
            <div class="col-md-10" style="border:1px solid;">
                <h5>Q13001b :<h5/>
                    ...
                    <h6>Can you please tell me why did you rate this operator based on their Communication
                        and Promotion? [MA]</h6>
                    <br>আপনিতো বললেন যে, এই ব্র্যান্ডটির প্রচার প্রচারণার কারনে আপনি এই অপারেটর
                    সম্বন্ধে অন্যকে পরামর্শ দিবেন? দয়া করে বলুন, প্রচার প্রচারণার সুনির্দিষ্ট কোন কোন
        ...
        <div class="container">
            <div class="col-md-10" style="border:1px solid;height: auto">
                <div class="container">
<form action="13001b.php" method="post">
    <fieldset class="form-group">
        ...
        <div class="container">
            <div class="col-md-10">
                <button type="submit" name="13001b_button" style="float: right" class="btn btn-primary">Next Page</button>
            </div>
        </div>
        </form>
        <br><br><br>
