...
<body>
        ...
        <div class="container">
                ...
                <h1 >1001bWALK IN CUSTOMER CARE CENTRE EXPERIENCE</h1>
        ...
        <div class="container">
            <div class="col-md-10" style="border:1px solid;">
                ...
                সম্বন্ধে অন্যকে পরামর্শ দিবেন? দয়া করে বলুন, কাস্টমার কেয়ার সেন্টারে সেবা পাওয়ার কোন
                কোন অভিজ্ঞতার কারনে আপনি অন্যকে পরামর্শ দিবেন?আর কিছু? আর কিছু?
                </p>
            </div>
            <br>
            <br>
        ...
        <div class="container">
            <div class="col-md-10" style="border:1px solid;height: auto">
                <div class="container">
 <form action="1001b.php" method="post">
     <fieldset class="form-group">
        ...
        <div class="container">
            <div class="col-md-10">
                <button type="submit" name="1001b_button" style="float: right" class="btn btn-primary">Next Page</button>
            </div>
        </div>
        </form>
        <br><br><br>
