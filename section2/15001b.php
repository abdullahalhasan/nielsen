...
<body>
        ...
        <div class="container">
            <div class="col-md-10" style="border:1px solid;">
                <h5>Q15001b :<h5/>
                    ...
                    <br>আপনিতো বললেন যে, গোপনে/আপনার অগোচরে টাকা কাটার কারনে আপনি এই অপারেটর
                    সম্বন্ধে অন্যকে পরামর্শ দিবেন? দয়া করে বলুন, গোপনে/ আপনার অগোচরে টাকা কাটার
        ...
        <div class="container">
            <div class="col-md-10" style="border:1px solid;height: auto">
                <div class="container">
<form action="15001b.php" method="post">
