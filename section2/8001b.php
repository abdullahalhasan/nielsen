...
<body>
        ...
        <div class="container">
            <div class="col-md-10" style="border:1px solid;">
                <h5>Q8001b :<h5/>
                    <p>
                    <h6>Can you please tell me why did you rate this operator based on offer? [MA]</h6> <br>আপনিতো বললেন যে, বিভিন্ন অফারের কারনে আপনি এই অপারেটর সম্বন্ধে অন্যকে
                    পরামর্শ দিবেন? দয়া করে বলুন, বিভিন্ন অফার বিষয়ক সুনির্দিষ্ট কোন কোন কারনে
        ...
        <div class="container">
            <div class="col-md-10" style="border:1px solid;height: auto">
                <div class="container">
<form action="8001b.php" method="post">
    <fieldset class="form-group">
        ...
        <div class="container">
            <div class="col-md-10">
                <button type="submit" name="8001b_button" style="float: right" class="btn btn-primary">Next Page</button>
            </div>
        </div>
</form>
        <br><br><br>
