...
<body>
        ...
        <div class="container">
            <div class="col-md-10" style="border:1px solid;">
                <h5>Q3001b :</h5>
                    ...
                    পরামর্শ দিবেন? দয়া করে বলুন, কথা বলার রেট বিষয়ক সুনির্দিষ্ট কোন কোন কারনে
        ...
        <div class="container">
            <div class="col-md-10" style="border:1px solid;height: auto">
                <div class="container">
<form action="3001b.php" method="post">
    <fieldset class="form-group">
        ...
        <div class="container">
            <div class="col-md-10">
                <button type="submit" name="3001b_button" style="float: right" class="btn btn-primary">Next Page</button>
            </div>
        </div>
</form>
        <section>
