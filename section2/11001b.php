...
<body>
        ...
        <div class="container">
            <div class="col-md-10" style="border:1px solid;">
                <h5>Q11001b :<h5/>
                    ...
                    <br>আপনিতো বললেন যে, ওয়েব সাইটের অভিজ্ঞতার কারনে আপনি এই অপারেটর সম্বন্ধে
                    অন্যকে পরামর্শ দিবেন? দয়া করে বলুন, ওয়েব সাইটের সুনির্দিষ্ট কোন কোন কারনে আপনি
                    অন্যকে পরামর্শ দিবেন?আর কিছু? আর কিছু?
                    </p>
            </div>
        ...
        <div class="container">
            <div class="col-md-10" style="border:1px solid;height: auto">
                <div class="container">
<form action="11001b.php" method="post">
    <fieldset class="form-group">
        ...
        <div class="container">
            <div class="col-md-10">
                <button type="submit" name="11001b_button" style="float: right" class="btn btn-primary">Next Page</button>
            </div>
        </div>
        </form>
        <br><br><br>
