...
<body>
        ...
        <div class="container">
            <div class="col-md-10" style="border:1px solid;">
                <h5>Q16001b :<h5/>
                    ...
                    <br>আপনিতো বললেন যে, দির্ঘ দিন ব্যবহারের ফলে প্রাপ্য সুবিধার কারনে আপনি এই অপারেটর
                    সম্বন্ধে অন্যকে পরামর্শ দিবেন? দয়া করে বলুন, দির্ঘ দিন ব্যবহারের ফলে প্রাপ্য সুবিধার
        ...
        <div class="container">
            <div class="col-md-10" style="border:1px solid;height: auto">
                <div class="container">
<form action="16001b.php" method="post">
