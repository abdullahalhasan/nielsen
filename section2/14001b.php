...
<body>
            ...
            <div class="col-md-10" style="border:1px solid;">
                <h5>Q14001b :<h5/>
                    ...
                    <h6>Can you please tell me why did you rate this operator based on Recharge Process?
                        [MA]</h6> 
                    <br>আপনিতো বললেন যে, রিচার্জ/রিলোড পদ্ধতির কারনে আপনি এই অপারেটর সম্বন্ধে অন্যকে
                    পরামর্শ দিবেন? দয়া করে বলুন, রিচার্জ পদ্ধতির সুনির্দিষ্ট কোন কোন কারনে আপনি
        ...
        <div class="container">
            <div class="col-md-10" style="border:1px solid;height: auto">
                <div class="container">
<form action="14001b.php" method="post">
