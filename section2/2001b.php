...
<body>
        ...
        <br><br>
         ...
         <div class="container">
                ...
                <h1 >2001bCall Centre Experience</h1>
        ...
        <div class="container">
            <div class="col-md-10" style="border:1px solid;">
                ...
                দিবেন? দয়া করে বলুন,কল সেন্টার থেকে সেবা পাওয়ার কোন কোন অভিজ্ঞতার কারনে
        ...
        <div class="container">
            <div class="col-md-10" style="border:1px solid;height: auto">
                <div class="container">
<form action="2001b.php" method="post">
    <fieldset class="form-group">
        ...
        <div class="container">
            <div class="col-md-10">
                <button type="submit" name="2001b_button" style="float: right" class="btn btn-primary">Next Page</button>
            </div>
        </div>
        </form>
        <br><br><br>
