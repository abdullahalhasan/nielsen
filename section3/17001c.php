...
<body>
        ...
        <div class="container">
            <div class="col-md-10" style="border:1px solid;">
                <h5>Q17001c :<h5/>
                    ...
                    <br>
                    আপনিতো বললেন যে, বন্ধু-বান্ধব/ আত্মীয় দের কারনে আপনি এই অপারেটর সম্বন্ধে অন্যকে
                    পরামর্শ দিবেন না? দয়া করে বলুন, বন্ধু-বান্ধব/ আত্মীয় দের সুনির্দিষ্ট কোন কোন কারনে
        ...
        <div class="container">
            <div class="col-md-10" style="border:1px solid;height: auto">
                <div class="container">
<form action="17001c.php" method="post">
        ...
        <div class="container">
            <div class="col-md-10">
                <button type="submit" name="17001c_button" style="float: right" class="btn btn-primary">Next Page</button>
            </div>
        </div>
        </form>
        <br><br><br>
