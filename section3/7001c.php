...
<body>
        ...
        <div class="container">
            ...
            <h1>7001c Data/ Internet service</h1>
            ...
            <div class="col-md-10" style="border:1px solid;">
                <h5>Q7001c :<h5/>
                    ...
                    <h6>Can you please tell me why did you rate this operator based on Data/ Internet Service?
                        [MA]</h6>
                    <br>
                    আপনিতো বললেন যে, ইন্টারনেট সেবার কারনে আপনি এই অপারেটর সম্বন্ধে অন্যকে
                    পরামর্শ দিবেন না? দয়া করে বলুন, ইন্টারনেট সেবা বিষয়ক সুনির্দিষ্ট কোন কোন কারনে
        ...
        <div class="container">
            <div class="col-md-10" style="border:1px solid;height: auto">
                <div class="container">
 <form action="7001c.php" method="post">
        ...
        <div class="container">
            <div class="col-md-10">
                <button type="submit" name="7001c_button" style="float: right" class="btn btn-primary">Next Page</button>
            </div>
        </div>
        </form>
        <br><br><br>
