...
<body>
        ...
        <div class="container">
            ...
            <h1>4001c. NETWORK &amp; CONNECTIVITY</h1>
        ...
        <div class="container">
            <div class="col-md-10" style="border:1px solid;">
                <h5>Q4001c :<h5/>
                    ...
                    সম্বন্ধে অন্যকে পরামর্শ দিবেন না? দয়া করে বলুন, নেটওয়ার্ক বিষয়ক সুনির্দিষ্ট কোন
        ...
        <div class="container">
            <div class="col-md-10" style="border:1px solid;height: auto">
                <div class="container">
 <form action="4001c.php" method="post">
     <fieldset class="form-group">
        ...
        <div class="container">
            <div class="col-md-10">
                <button type="submit" name="4001c_button" style="float: right" class="btn btn-primary">Next Page</button>
            </div>
        </div>
        </form>
        <br><br><br>
