...
<body>
        ...
        <div class="container">
            <div class="col-md-10" style="border:1px solid;">
                <h5>Q12001c :<h5/>
                    ...
                    <br>
                    আপনিতো বললেন যে, ব্র্যান্ড/কম্পানীর সুনামের কারনে আপনি এই অপারেটর সম্বন্ধে
                    অন্যকে পরামর্শ দিবেন না? দয়া করে বলুন, ব্র্যান্ড/কম্পানীর সুনামের সুনির্দিষ্ট কোন কোন
        ...
        <div class="container">
            <div class="col-md-10" style="border:1px solid;height: auto">
                <div class="container">
 <form action="12001c.php" method="post">
     <fieldset class="form-group">
        ...
        <div class="container">
            <div class="col-md-10">
                <button type="submit" name="12001c_button" style="float: right" class="btn btn-primary">Next Page</button>
            </div>
        </div>
        </form>
        <br><br><br>
