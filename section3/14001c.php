    ...
    <form class="form-inline">
        ...
        <div class="container">
            <div class="col-md-10" style="border:1px solid;">
                <h5>Q14001c :<h5/>
                    <p>
                    <h6>Can you please tell me why did you rate this operator based on Recharge Process?
                        [MA]</h6>
                    <br>
                    আপনিতো বললেন যে, রিচার্জ/রিলোড পদ্ধতির কারনে আপনি এই অপারেটর সম্বন্ধে অন্যকে
                    পরামর্শ দিবেন না? দয়া করে বলুন, রিচার্জ পদ্ধতির সুনির্দিষ্ট কোন কোন কারনে আপনি
                    অন্যকে পরামর্শ দিবেন না?আর কিছু? আর কিছু?
                    </p>
            </div>
...
<div class="container">
    <div class="col-md-10" style="border:1px solid;height: auto">
        <div class="container">
 <form action="14001c.php" method="post">
     <fieldset class="form-group">
        ...
        <div class="container">
            <div class="col-md-10">
                <button type="submit" name="14001c_button" style="float: right" class="btn btn-primary">Next Page</button>
            </div>
        </div>
        </form>
        <br><br><br>
