...
if(isset($_POST['xyz'])){
  ...
  $aidm=$radio_button;
    ...
    dba_start($qid,$aid);
//db ends here
    $_SESSION['nps2c']=$checkboxArray;
    $count=0;
    $_SESSION['nps2c_count']=$count;
    
 
    switch ($radio_button) {
        case '01':
        echo "<script type='text/javascript'> location.href='1001c.php'</script>";
            break;

        case '02':
        echo "<script type='text/javascript'> location.href='2001c.php'</script>";
            break;
        
         case '03':
         echo "<script type='text/javascript'> location.href='3001c.php'</script>";
            break;
         case '04':
         echo "<script type='text/javascript'> location.href='4001c.php'</script>";
            break;
         case '05':
         echo "<script type='text/javascript'> location.href='5001c.php'</script>";
            break;
         case '06':
         echo "<script type='text/javascript'> location.href='6001c.php'</script>";
            break;
         case '07':
         echo "<script type='text/javascript'> location.href='7001c.php'</script>";
            break;
         case '08':
         echo "<script type='text/javascript'> location.href='8001c.php'</script>";
            break;
         case '09':
         echo "<script type='text/javascript'> location.href='9001c.php'</script>";
            break;
         case '10':
         echo "<script type='text/javascript'> location.href='10001c.php'</script>";
           
        break;
            case '11':
            echo "<script type='text/javascript'> location.href='11001c.php'</script>";
                break;
    
            case '12':
            echo "<script type='text/javascript'> location.href='12001c.php'</script>";
                break;
            
             case '13':
             echo "<script type='text/javascript'> location.href='13001c.php'</script>";
                break;
             case '14':
             echo "<script type='text/javascript'> location.href='14001c.php'</script>";
                           break;
             case '15':
             echo "<script type='text/javascript'> location.href='15001c.php'</script>";
           
                break;
             case '16':
             echo "<script type='text/javascript'> location.href='16001c.php'</script>";
            
                break;
             case '17':
             echo "<script type='text/javascript'> location.href='17001c.php'</script>";
            
                break;
             case '18':
             echo "<script type='text/javascript'> location.href='18001c.php'</script>";
...
<div class="container">
    ...
    <form action="nps2c.php" method="post">
