...
<body>
        ...
        <div class="container">
            ...
            <h1>6001c.Value Added Service (VAS)</h1>
        ...
        <div class="container">
            <div class="col-md-10" style="border:1px solid;">
                <h5>Q6001c :<h5/>
                    ...
                    <br>
                     আপনিতো বললেন যে, ভ্যালু আডেড সেবার কারনে আপনি এই অপারেটর সম্বন্ধে
                    অন্যকে পরামর্শ দিবেন না? দয়া করে বলুন, ভ্যালু আডেড সেবা বিষয়ক সুনির্দিষ্ট কোন কোন
        ...
        <div class="container">
            <div class="col-md-10" style="border:1px solid;height: auto">
                <div class="container">
 <form action="6001c.php" method="post">
     <fieldset class="form-group">
        ...
        <div class="container">
            <div class="col-md-10">
                <button type="submit" name="6001c_button" style="float: right" class="btn btn-primary">Next Page</button>
            </div>
        </div>
