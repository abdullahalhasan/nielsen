...
<body>
        ...
        <div class="container">
            <div class="col-md-12" style="border:1px solid;">
                <h5>Q8001a :<h5/>
					...
					<br>পরামর্শ দিবেন? দয়া করে বলুন,  বিভিন্ন অফার বিষয়ক সুনির্দিষ্ট কোন কোন কারনে আপনি অন্যকে পরামর্শ দিবেন?আর কিছু? আর কিছু?আপনিতো বললেন যে,  বিভিন্ন অফারের কারনে আপনি এই অপারেটর  সম্বন্ধে অন্যকে 
                    </p>
            </div>
        ...
        <div class="container">
            <div class="col-md-12" style="border:1px solid;height: auto">
                <div class="container">
<form action="8001a.php" method="post">
