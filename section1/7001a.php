...
<body>
        ...
        <div class="container">
            ...
            <h1>7001a Data/ Internet service</h1>
        ...
        <div class="container">
            <div class="col-md-12" style="border:1px solid;">
                <h5>Q7001a :<h5/>
                    <p>
                    <h6>Can you please tell me why did you rate this operator based on Data/ Internet Service? [MA] </h6>
                    <br>আপনিতো বললেন যে,   ইন্টারনেট সেবার কারনে আপনি এই অপারেটর  সম্বন্ধে অন্যকে পরামর্শ দিবেন? দয়া করে বলুন, ইন্টারনেট সেবা বিষয়ক সুনির্দিষ্ট কোন কোন কারনে আপনি অন্যকে পরামর্শ দিবেন?আর কিছু? আর কিছু?
                    </p>
            </div>
        ...
        <div class="container">
            <div class="col-md-12" style="border:1px solid;height: auto">
                <div class="container">
                    <form action="7001a.php" method="post">
