...
<body>
        ...
        <div class="container">
            ...
            <h1>13001a COMMUNICATION AND PROMOTION </h1>
        ...
        <div class="container">
            <div class="col-md-12" style="border:1px solid;">
                <h5>Q13001a :<h5/>
                    <p>
                    <h6>Can you please tell me why did you rate this operator based on their Communication and Promotion? [MA] </h6>
                    <br>আপনিতো বললেন যে,  এই ব্র্যান্ডটির প্রচার প্রচারণার  কারনে আপনি এই অপারেটর  সম্বন্ধে অন্যকে পরামর্শ দিবেন? দয়া করে বলুন,    প্রচার প্রচারণার সুনির্দিষ্ট কোন কোন কারনে আপনি অন্যকে পরামর্শ দিবেন?আর কিছু? আর কিছু?
                    </p>
            </div>
        ...
        <div class="container">
            <div class="col-md-12" style="border:1px solid;height: auto">
                <div class="container">
                    <form action="13001a.php" method="post">
