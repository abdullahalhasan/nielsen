...
//db ends here
    ...
    $_SESSION['nps2a']=$checkboxArray;
    $count=0;
    $_SESSION['nps2a_count']=$count;
    
 
    switch ($radio_button) {
        case '01':
        echo "<script type='text/javascript'> location.href='1001a.php'</script>";
            break;

        case '02':
        echo "<script type='text/javascript'> location.href='2001a.php'</script>";
            break;
        
        case '03':
        echo "<script type='text/javascript'> location.href='3001a.php'</script>";
            break;
        case '04':
        echo "<script type='text/javascript'> location.href='4001a.php'</script>";
            break;
        case '05':
        echo "<script type='text/javascript'> location.href='5001a.php'</script>";
            break;
        case '06':
        echo "<script type='text/javascript'> location.href='6001a.php'</script>";
            break;
        case '07':
        echo "<script type='text/javascript'> location.href='7001a.php'</script>";
            break;
        case '08':
        echo "<script type='text/javascript'> location.href='8001a.php'</script>";
            break;
        case '09':
        echo "<script type='text/javascript'> location.href='9001a.php'</script>";
            break;
        case '10':
        echo "<script type='text/javascript'> location.href='10001a.php'</script>";
        
        break;
            case '11':
            echo "<script type='text/javascript'> location.href='11001a.php'</script>";
                break;

            case '12':
            echo "<script type='text/javascript'> location.href='12001a.php'</script>";
                break;
            
            case '13':
            echo "<script type='text/javascript'> location.href='13001a.php'</script>";
                break;
            case '14':
            echo "<script type='text/javascript'> location.href='14001a.php'</script>";
                        break;
            case '15':
            echo "<script type='text/javascript'> location.href='15001a.php'</script>";
        
                break;
            case '16':
            echo "<script type='text/javascript'> location.href='16001a.php'</script>";
            
                break;
            case '17':
            echo "<script type='text/javascript'> location.href='17001a.php'</script>";
            
                break;
            case '18':
            echo "<script type='text/javascript'> location.href='18001a.php'</script>";
...
<div class="container">
    <div class="col-md-12" style="border:1px solid;height: auto;">
        ...
        <div class="container">
<form action="nps2a.php" method="post">
                    ...
                    <div class="row" style="margin-top: 40px;">
                        ...
                        <div class="col-md-6">
                            ...
                            <div id="cradio_02" class="form-check col-md-3" style="display: true; float: left;" >
                                <input class="form-check-input" type="checkbox" id="checkbox_02" name="gBrand_number_radio[]"  value="02" >
                                <label class="form-check-label" for="Brand_number_radio2">
                                   02
                                </label>
                            </div>
