...
<body>
        ...
        <div class="container">
            ...
            <h1>9001a RETAIL OUTLET EXPERIENCE</h1>
        ...
        <div class="container">
            <div class="col-md-12" style="border:1px solid;">
                <h5>Q9001a :</h5>
                    <p>
                    <h6>Can you please tell me why did you rate this operator based on Retail Outlet Experience? [MA] </h6> 
                    <br>আপনিতো বললেন যে, বিক্রয়কেন্দ্রের অভিজ্ঞতার কারনে আপনি এই অপারেটর সম্বন্ধে অন্যকে পরামর্শ দিবেন? দয়া করে বলুন,  বিক্রয়কেন্দ্রের অভিজ্ঞতা সুনির্দিষ্ট কোন কোন কারনে আপনি অন্যকে পরামর্শ দিবেন?আর কিছু? আর কিছু?
                    </p>
            </div>
        ...
        <div class="container">
            <div class="col-md-12" style="border:1px solid;height: auto">
                <div class="container">
                    <form action="9001a.php" method="post">
