...
<div class="container">
    <div class="col-md-10" style="border:1px solid;">
        <h5>CSS3b:<h5/>
            <p>
            <h6>[ASK IF BL IS SELECTED IN Q101A]
                Thinking of Banglalink, on a scale of 0 to 10, how satisfied you are on your operator for each of these factors? Where 0 being Extremely Dissatisfied and 10 being Extremely Satisfied.
                [Probe each of the factors to capture level of satisfaction]
                [Rotate]
                <br><br>
                যদি Q101A প্রশ্নে উত্তরদাতা  BL কোড করে থাকেন, শুধুমাত্র তাহলে জিজ্ঞাসা করুন]
...
<div class="container">
    <div class="col-md-10" style="border:1px solid;height: auto;">
        ...
        <div class="container">
            <form action="css3b.php" method="post">
...
<div class="container">
    <div class="col-md-12">
        <button type="submit" name="css3b_btn" style="float: right" class="btn btn-primary">Next Page</button>
    </div>
</div>
</form>
<br><br><br>
