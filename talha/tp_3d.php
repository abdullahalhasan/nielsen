...
$check_values = $_SESSION['aitel_values'];
...
<div class="container">
    <div class="col-md-10" style="border:1px solid;">
        <h5>TP3d:<h5/>
            <p>
            <h6>[ASK IF airtel CODED IN TP1] / যদি TP1 প্রশ্নে উত্তরদাতা airtel কোড করে থাকেন, শুধুমাত্র তাহলে জিজ্ঞাসা করুন]
                <br>You said you [SAY: OPTIONS MENTIONED IN TP1] for airtel. How satisfied were you after getting the service? Please answer using a scale of 0 to 10, where 0 is Highly Dissatisfied and 10 is Extremely Satisfied. [SA]
...
<div class="container">
    <div class="col-md-10" style="border:1px solid;height: auto;">
        ...
        <div class="container">
            <form action="tp_3d.php" method="post">
...
<div class="container">
    <div class="col-md-10">
        <button type="submit" name="tp3d_btn" style="float: right" class="btn btn-primary">Next Page</button>
    </div>
</div>
</form>
<br><br><br>
