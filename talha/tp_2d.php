...
<div class="container">
    <div class="col-md-10" style="border:1px solid;">
        <h5>TP2d:<h5/>
            <p>
                Why did you… [If Airtel is selected in q101a & tp1]
            <br>
...
<div class="container">
    <div class="col-md-10" style="border:1px solid;height: auto;">
        ...
        <div class="container">
            ...
            <form action="tp_2d.php" method="post">
...
<div class="container">
    <div class="col-md-10">
        <button type="submit" name="tp2d_btn" style="float: right" class="btn btn-primary">Next Page</button>
    </div>
</div>
</form>
<br><br><br>
