...
if (isset($_POST['tp1_btn'])) {
    ...
    $airtel_values = $_POST[$array_count.'_radio'];
    $tp_count ++;
    $_SESSION['tp1_count'] = $tp_count;
    $_SESSION['aitel_values'] = $airtel_values;

    $qid = 'TP1d';
    $aid = $_POST[$array_count.'_radio'];
    dba_start($qid,arr_concate($aid));

//    echo json_encode($airtel_values);
//    die;
...
<div class="container">
    <div class="col-md-12" style="border:1px solid;">
        <h5>TP1a:</h5>
            <p>
                Do You? if [Airtel is selected in q101a]
                <br>
            </p>
    </div>
...
<div class="container">
    <div class="col-md-12" style="border:1px solid;height: auto;">
        ...
        <div class="container">
            <form action="tp_1d.php" method="post">
