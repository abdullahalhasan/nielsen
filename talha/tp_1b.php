...
if (isset($_POST['tp1_btn'])) {
    ...
    $bl_values = $_POST[$array_count.'_radio'];
    $_SESSION['bl_values'] = $bl_values;
    ...
    if (1==2) {
        ...
        $_SESSION['tp_2_count'] = $array_count++;
        ...
        if ($tp_count != $operator_count) {
            ...
            $tp_op_count = 0;
            $_SESSION['tp_op_count'] = $tp_op_count;
...
<div class="container">
    <div class="col-md-12" style="border:1px solid;">
        <h5>TP1a:<h5/>
            <p>
                Do You? if [BL is selected in q101a]
                <br>
            </p>
    </div>
...
<div class="container">
    <div class="col-md-12" style="border:1px solid;height: auto;">
        ...
        <div class="container">
            <form action="tp_1b.php" method="post">
