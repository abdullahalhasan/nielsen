<?php
    ...
    /*echo $tp_opt_list[$tp_count];
    echo $operator_count;
    echo $tp_count;
    die;*/
    if (isset($_POST['tp2a_btn'])) {
        //echo die;
        $tp_count++;
...
<div class="container">
    <div class="col-md-10" style="border:1px solid;">
        <h5>TP2a:<h5/>
            <p>
                Why did you… [If GP is selected in q101a & tp1]
            <br>
...
<div class="container">
    <div class="col-md-10">
        <button type="submit" name="tp2a_btn" style="float: right" class="btn btn-primary">Next Page</button>
    </div>
</div>
</form>
<br><br><br>
