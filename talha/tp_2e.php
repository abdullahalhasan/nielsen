<?php
    ...
    //echo json_encode($operator_list_array)."<br>";
...
<div class="container">
    <div class="col-md-10" style="border:1px solid;">
        <h5>TP2e:<h5/>
            <p>
                Why did you… [If TT is selected in q101a & tp1]
            <br>
                আপনি কি কারনে/ কি ব্যাপারে/ …
                <br>
            </p>
    </div>
...
<div class="container">
    <div class="col-md-10" style="border:1px solid;height: auto;">
        ...
        <div class="container">
            ...
            <form action="tp_2e.php" method="post">
...
<div class="container">
    <div class="col-md-10">
        <button type="submit" name="tp2e_btn" style="float: right" class="btn btn-primary">Next Page</button>
    </div>
</div>
</form>
<br><br><br>
