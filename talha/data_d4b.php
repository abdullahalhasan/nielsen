...
<body>
        ...
        <div class="container">
            <div class="col-md-12" style="border:1px solid;">
                <h5>D4 b:</h5>
                <p>
                <h6>[ASK THIS QUESTION ONLY IF BL IS SELECTED IN Q101d] [ যদি Q101d প্রশ্নে উত্তরদাতা BL নির্বাচন করে থাকেন, শুধুমাত্র তাহলে জিজ্ঞাসা করুন]
                    <br>Can you please tell me why did you rate Banglalink based on its Data Service? [MA]
                    [PROBE]
                    <br><br>দয়া করে বলুন   BL এর ইন্টারনেট সেবার ব্যাপারে আপনার এরকম রেটিং দেওয়ার কারনগুলো কি কি? আর কিছু?  [একাধিক উত্তর হবে]
                </h6>
                </p>
            </div>
            <br>
        ...
        <div class="container" >
            <form action="data_d4b.php" method="post">
        ...
        <div class="container">
            <div class="col-md-12">
                <button type="submit" name="datad4b_btn" style="float: right" class="btn btn-primary">Next Page</button>
            </div>
        </div>
        </form>
